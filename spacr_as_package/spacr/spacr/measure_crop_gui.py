...
def measure_gui():
    ...
    variables = {
        ...
        'crop_mode':('combo', ['cell', 'nucleus', 'pathogen', 'cytoplasm'], 'cell'),
        ...
        'plot_filtration':('check', None, False),
        'include_uninfected':('check', None, False),
        ...
        'cell_loc':('entry', None, [[], []]),
        'pathogens':('entry', None, []), 
        'pathogen_loc':('entry', None, [[], []]),
        'treatments':['cm','lovastatin_20uM'],
        'treatment_loc':('entry', None, []),
