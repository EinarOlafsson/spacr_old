...
def _z_to_mip(src, regex, batch_size=100, pick_slice=False, skip_mode='01', metadata_type=''):
    ...
    from .utils import _safe_int_convert
...
def preprocess_img_data(settings):
    ...
    if most_common_extension in ['tif', 'tiff', 'png', 'jpeg']:
    ...
    save_dtype = settings['save_dtype']
    correct_illumination = settings['correct_illumination']
